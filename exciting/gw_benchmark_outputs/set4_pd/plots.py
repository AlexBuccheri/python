...
def gw_basis_convergence(root: str):
    ...
    max_energy_exts_set4_pd = ['i0', 'i1', 'i2', 'i3', 'i4', 'i5', 'i6', 'i7', 'i8', 'i9']

    settings_set4_pd = {'rgkmax': 8,
...
gw_basis_convergence("/users/sol/abuccheri/gw_benchmarks/A1_more_APW/set4_pd")
