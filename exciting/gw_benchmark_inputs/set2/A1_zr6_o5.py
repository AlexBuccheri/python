...
def set_up_g0w0(root_path:str):
    ...
    energy_cutoffs =  {'zr': {0: np.linspace(60, 120, num=4),
                              ...
                              4: np.linspace(60, 120, num=4),
                              5: np.linspace(60, 120, num=4),
                              6: np.linspace(60, 120, num=4)},
...
set_up_g0w0("/users/sol/abuccheri/gw_benchmarks/A1_var_cutoff/zr_lmax6_o_lmax5_rgkmax7")