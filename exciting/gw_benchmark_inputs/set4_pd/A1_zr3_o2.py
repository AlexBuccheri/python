...
from gw_benchmark_inputs.set4_pd.A1_groundstate import converged_ground_state_input as A1_gs_input
...
def set_up_g0w0(root_path: str):
    ...
    # Increased rgkmax to 8                                   Zrl0   l2   l3   l4
    energy_cutoffs = {'zr': {0: [180, 180, 180, 180, 180, 180, 300, 180, 180, 180],
                             1: [180, 200, 250, 300, 350, 400, 180, 180, 180, 180],
                             2: [180, 180, 180, 180, 180, 180, 180, 400, 180, 180],
                             3: [180, 180, 180, 180, 180, 180, 180, 180, 420, 180]},

                      'o': {0: [140, 140, 140, 140, 140, 140, 140, 140, 140, 140],
                            1: [140, 140, 140, 140, 140, 140, 140, 140, 140, 140],
                            2: [140, 140, 140, 140, 140, 140, 140, 140, 140, 140]}
                      }
...
if __name__ == "__main__":
    ...
    set_up_g0w0("/users/sol/abuccheri/gw_benchmarks/A1_more_APW/set4_pd/zr_lmax3_o_lmax2_rgkmax8")
